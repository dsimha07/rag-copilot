...
⬜ Evaluation suite — golden Q&A set and metrics
⬜ Streamlit dashboard
...
# ask without citation verification (faster, for testing)
...
are flagged in the "Could Not Verify" section. This makes every answer
auditable — instead of trusting the model, each claim traces back to a source
...
flag fires, overall confidence is hard-capped at 0.40 regardless of other
signals.
